...
#endif
#include "kv_cache.h"                            /* FreeToken PoC: cache KV in RAM host */
#ifdef __AVX2__
#include <immintrin.h>
...
/* --- FreeToken PoC: cache KV lato host -----------------------------------
 * prompt_hash: FNV-1a 64-bit sulla sequenza di token -> id testuale del prompt.
